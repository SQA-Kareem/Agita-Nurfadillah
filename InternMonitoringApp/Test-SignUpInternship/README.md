...
| ----------------- | ---------- | --------------------------------------------------------- |
| SignUp Internship | Berhasil ✔ | [dokumentasi](<TestingSignUp_Agita Nurfadillah_1214029.pdf>) |
...
1. Buka file `testing-signup.py` dan lakukan modifikasi sesuai dengan kebutuhan Anda, seperti URL halaman web yang ingin diuji, informasi login, dll. Sesuaikan path lokasi file sebelumkan menjalankan pengujian.
